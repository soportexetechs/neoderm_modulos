...
class SaleInvoiceDataImport(models.TransientModel):
    _name = 'sale.invoice.data.import'

    xls_file = fields.Binary('File')
    journal_id = fields.Many2one('account.journal', string='Journal', required=True, domain="[('type', 'in', ['sale'])]")
